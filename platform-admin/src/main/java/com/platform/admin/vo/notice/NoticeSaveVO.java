 ...
 * 通知公告添加入参 VO
 *
 * <p>字段长度依据 sys_notice 表定义：
 * notice_title VARCHAR(128)、notice_type TINYINT、position TINYINT、
 * notice_content TEXT、status TINYINT、remark VARCHAR(255)</p>
 *
 * @author platform
 */
@Data
@Schema(description = "通知公告添加参数")
