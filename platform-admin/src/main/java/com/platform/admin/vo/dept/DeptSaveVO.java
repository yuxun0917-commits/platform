 ...
 *
 * <p>字段长度依据 dept 表定义：
 * dept_name VARCHAR(64)、leader VARCHAR(64)、phone VARCHAR(20)、
 * email VARCHAR(128)、remark VARCHAR(255)</p>
 *
 * @author platform
 */
@Data
@Schema(description = "部门添加参数")
public class DeptSaveVO implements Serializable {
