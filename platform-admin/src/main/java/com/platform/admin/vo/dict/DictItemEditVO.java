 ...
 * 字典项编辑入参 VO
 *
 * <p>在 DictItemSaveVO 基础上增加 id 字段，其他字段校验与 DictItemSaveVO 一致。
 * 字段长度依据 sys_dict_item 表定义。</p>
 *
 * @author platform
 */
@Data
@Schema(description = "字典项编辑参数")
public class DictItemEditVO implements Serializable {
