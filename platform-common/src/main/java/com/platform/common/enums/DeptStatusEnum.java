 ...
 * 部门状态枚举
 *
 * <p>对应 dept 表的 status 字段：1=正常 0=禁用</p>
 *
 * @author platform
 */
public enum DeptStatusEnum {
    ...
    DeptStatusEnum(Integer code, String desc) {
        this.code = code;
        this.desc = desc;
    }
     ...
     */
    public static DeptStatusEnum getByCode(Integer code) {
        if (Objects.isNull(code)) {
            return null;
        }
        for (DeptStatusEnum value : values()) {
